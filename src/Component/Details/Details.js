...
const Details = (props) => {   
    ...
    const handleClick = event => {
        setBreakTime(event.currentTarget.value);
    }
            ...
            <div className=' p-5 pt-10 shadow-xl mx-3 bg-slate-100  mt-5 rounded-lg '>
                ...
                <div>
                    ...
                    <div className='flex my-5'>
                        <h1 className='text-lg font-medium pr-2'>Break Time : <span className='text-center text-gray-600 font-normal pl-5'>{breakTime} min</span></h1>
                    </div>

                    {/* toast button */}
                    <button onClick={showToastMessage} className='w-full text-lg font-semibold bg-blue-400 hover:bg-blue-600 px-10 py-2 mt-5 rounded-md text-white '>Activity Completed</button>
                    <ToastContainer />
                </div>
            </div>
        </div>
